...
class DatastoreDeletionManager:
    ...
    def _get_selected_datastores(self):
        ...
        if not selected_items:
            QMessageBox.information(self.main, "No Selection",
                                    "Please select one or more datastores or coveragestores to delete.")
            return None
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.main.log_message(
                    ...
                    f"Status: {response.status_code}, Response: {error_message}",
                    level=Qgis.Critical
                )
