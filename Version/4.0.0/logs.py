...
class LogWindow(QDialog):
    ...
    def append_message_with_color(self, message, level=None):
        ...
        if (level == Qgis.Critical or "✗" in message_str or "Error:" in message_str
                or "Failed:" in message_str or "was not loaded" in message_str):
        ...
        html_text = (
            f'<span style="color: {color}; font-family: Consolas, Monaco, Courier New; '
            f'font-size: 9pt;">{message_str}</span><br>'
        )
    ...
    def append_layer_title(self, layer_name):
        ...
        html_text = (
            f'<span style="color: #0078d4; font-family: Consolas, Monaco, Courier New; '
            f'font-size: 11pt; font-weight: bold;">{title_message}</span><br>'
        )
        cursor.insertHtml(html_text)
...
"""
    ...
    def show_completion_popup(self, parent=None):
        ...
        from qgis.PyQt.QtWidgets import (
            QDialog, QVBoxLayout, QLabel, QTableWidget, QPushButton, QHBoxLayout,
