...
class LayerMetadataExtractor:
    ...
    def get_layer_style(self, url, auth, workspace, layer_name):
        ...
        try:
            ...
            if response.status_code == 200:
                print("DEBUG: Got style from workspace")
            ...
            if response.status_code == 200:
                print("DEBUG: Got style from global styles")
                return response.text
    ...
    def get_layer_data_store(self, url, auth, workspace, layer_name):
        ...
        try:
            ...
            if response.status_code == 200:
                print("DEBUG: Got datastore config successfully")
                return response.json()
            else:
    ...
    def get_feature_type_info(self, url, auth, workspace, layer_name):
        ...
        try:
            ...
            if response.status_code == 200:
                print("DEBUG: Got feature type from direct URL")
                return response.json()
            ...
            if layer_response.status_code == 200:
                ...
                if resource_href:
                    ...
                    if ft_response.status_code == 200:
                        print("DEBUG: Got feature type from resource href")
