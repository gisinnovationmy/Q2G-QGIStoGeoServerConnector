...
from qgis.PyQt.QtWidgets import (
    ...
    QListWidget, QListWidgetItem, QMessageBox, QGroupBox, QSpinBox, QComboBox
)
...
class PostGISCredentialsDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setStyleSheet('''
                ...
                QLineEdit, QSpinBox, QListWidget { font-size: 10pt; background: #fff;
    ...
    def delete_selected_connection(self):
        ...
        reply = QMessageBox.question(
            ...
            f"{conn_data['database']}@{conn_data['host']}:{conn_data['port']}?",
