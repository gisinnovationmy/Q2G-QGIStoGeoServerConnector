...
class SLDWindowManager:
    ...
    def _extract_sld_content(self, layer, show_dialogs=True):
        """
        Extract SLD content from a layer using a temporary file approach.

        Args:
            layer: QGIS layer object
            show_dialogs: If True, show QMessageBox dialogs on errors/warnings.
                          Set to False when calling from a background thread.
